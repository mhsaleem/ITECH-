...
LOGIN_REDIRECT_URL = '/punny/'  # The page you want users to arrive at after they successful log in
...
ALLOWED_HOSTS = ['rorybain.pythonanywhere.com', '127.0.0.1', 'localhost']
